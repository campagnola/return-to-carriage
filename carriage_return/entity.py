...
class Entity:
    ...
    def __init__(self, entity_type, obj_name=None):
        ...
        # Most entities are not separately perceivable, so this stays empty. A
        # hidden button or an invisible mob adds one or more Percepts (see
        # perception.py) so the scene's perception resolver can treat them like
